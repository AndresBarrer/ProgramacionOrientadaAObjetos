...
public class Equipo {
    ...
    private void agregarJugador(){
        ...
        for(int i=0; i<this.getNumeroJugadores(); i++){
            ...
            CapturaDeEntradas.capturarEntero("Introducir numero de uniforme")), 
            CapturaDeEntradas.capturarString("Introducir nombre"), 
            CapturaDeEntradas.capturarEntero("Puntos anotados"), 
            CapturaDeEntradas.capturarString("Posicion"),
            CapturaDeEntradas.capturarFloat("Estatura"));
        ...
        if(this.jugadores.isEmpty()){
            ...
            for(int i=0; i<this.getJugadoresRegistrados();i++){
                if(numeroDeUniforme==this.jugadores.get(i).getNumeroUniforme()){
                    numeroDeUniforme=CapturaDeEntradas.capturarEntero("Invalido. Ingresar otro numero disponible");
                }
            }
        }
        return numeroDeUniforme;
